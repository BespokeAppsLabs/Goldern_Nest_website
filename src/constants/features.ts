import {
  ...
  BiosecurityIcon,
  BulkOrdersIcon,
  CarefulPackagingIcon,
  ChickenEmoji,
  ColorfulVarietyIcon,
  DailyHealthChecksIcon,
  EggEmoji,
  FarmFreshIcon,
  FarmVisitsIcon,
  FreeRangeIcon,
    ...
    highlights: [
      {
        ...
        description:
          'Nutritious and delicious eggs sourced directly from our farm.',
      },
      {
        icon: ChickenEmoji,
        title: 'Healthy Chickens',
        description:
          'Well-cared for poultry raised with natural feed and proper welfare.',
      },
      {
        icon: StarEmoji,
        title: 'Trusted Quality',
        description:
          'Certified processes ensuring safety and freshness every step of the way.',
      },
    ],
  },
  products: {
    benefits: [
      ...
      },
      {
        ...
        description:
          'Rare breed chickens fed exclusively on certified organic feed',
        features: [
      ...
      },
      {
        ...
        description:
          "Experience nature's diversity with our specialty egg collection",
        features: [
  ...
  quality: {
    standards: [
      {
        ...
        description:
          'Every bird receives daily health monitoring by qualified veterinarians',
      },
      {
        icon: TemperatureControlIcon,
        title: 'Temperature Control',
        description:
          'Maintained freshness through controlled storage and cold-chain delivery',
      },
      {
        icon: CarefulPackagingIcon,
        title: 'Careful Packaging',
        description:
          'Prevent damage during transport with our specialized packaging',
      },
      {
    ...
    environmental: [
      ...
      },
      {
        ...
        title: 'Zero Waste',
        description:
          'Composting program turns waste into nutrient-rich fertilizer',
      },
      {
  ...
  services: {
    delivery: [
      ...
      },
      {
        ...
        title: 'Bulk Orders',
        description:
          'Special pricing for restaurants, hotels, and large families',
        benefits: [
          'Competitive pricing',
    ...
    ordering: [
      ...
      },
      {
        ...
        title: 'Farm Visits',
        description:
          'Schedule tours to see our sustainable practices firsthand',
        experience: [
          'Meet our chickens',
          'See our facilities',
          'Learn our process',
...
export const QualityContent = {
  ...
  certifications: [
    ...
    },
    {
      ...
      description:
        'Our quality management system is certified to international standards.',
      icon: Iso9001Icon,
    },
    {
      id: 'haccp',
  ...
  faqs: [
    ...
    },
    {
      ...
      answer:
        'We maintain multiple certifications including ISO 9001, HACCP, and local food safety standards. All certifications are regularly audited and renewed.',
    },
  ],
};
