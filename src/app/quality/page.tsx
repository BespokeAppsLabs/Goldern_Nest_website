      ...
      <main className="max-w-6xl mx-auto px-4 md:px-6 py-12 md:py-16">
        ...
        <section className="mb-12 md:mb-16 flex justify-center">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 md:gap-8 text-center justify-center">
            {QualityContent.stats.map((stat) => (
              <div
                key={stat.label}
                className="p-6 md:p-8 bg-gradient-to-br from-primary-50 to-accent-50 rounded-2xl shadow-md"
              >
          ...
          <div className="grid grid-cols-2 sm:grid-cols-4 gap-4 md:gap-8">
            {QualityContent.process.map((step) => (
              <div key={step.step} className="text-center">
                <div className="w-12 h-12 md:w-16 md:h-16 bg-primary-600 text-white rounded-full flex items-center justify-center text-lg md:text-2xl font-bold mx-auto mb-3 md:mb-4">
                  {step.step}
                </div>
                <h3 className="text-sm md:text-lg font-semibold mb-1 md:mb-2 text-gray-900">
                  {step.title}
                </h3>
        ...
        <section className="text-center">
          ...
          <p className="text-base md:text-lg text-gray-700 mb-6 md:mb-8 max-w-3xl mx-auto px-4 md:px-0">
            We believe that quality is not just about meeting standards—it's
            about exceeding them. Every day, we work to improve our processes
            and ensure that our customers receive the best possible poultry
            products.
          </p>
