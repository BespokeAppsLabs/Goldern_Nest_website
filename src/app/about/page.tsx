    ...
    <>
      ...
      <main className="max-w-6xl mx-auto px-6 py-16">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl font-bold mb-6 text-gray-900">{AboutContent.title}</h1>
        ...
        <section className="text-center">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            {AboutContent.team.map((member) => (
              <div key={member.role} className="p-6 bg-white rounded-2xl shadow-md">
                ...
                <h3 className="text-xl font-semibold mb-2 text-gray-900">{member.role}</h3>
